...
<v-card class="ma-3 pa-3">
  <div>
    <h3 class="headline mb-0" style="font-weight:bold">Valued customers</h3>
    <v-data-table
      :headers="headers"
      :items="suppItems"
      :items-per-page="5"
...
LEFT OUTER JOIN part \
 ...
 where part.imported_country is not null ;",
      headers: [
        { text: "Customer id", value: "cust_id", align: "start" },
        { text: "First Name", value: "cust_fname" },
        { text: "Last Name", value: "cust_lname" },
        { text: "Last Name", value: "total_amount" },
